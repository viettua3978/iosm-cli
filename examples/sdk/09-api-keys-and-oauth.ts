...
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "iosm-cli";

// Default: AuthStorage uses ~/.iosm/agent/auth.json
// ModelRegistry loads built-in + custom models from ~/.iosm/agent/models.json
