...
export function printHelp(): void {
	console.log(`${chalk.bold(APP_NAME)} - IOSM agent CLI with read, bash, edit, write tools

${chalk.bold("Usage:")}
  ${APP_NAME} [options] [@files...] [messages...]

${chalk.bold("Commands:")}
  ${APP_NAME} init [path] [--force]   Initialize IOSM, analyze project, run verification, and create IOSM.md playbook
  ${APP_NAME} cycle <subcommand>      Manage IOSM cycle scaffolds, reports, and status
...
${chalk.bold("Examples:")}
  ...
  # Initialize IOSM config and artifact scaffold
  ${APP_NAME} init

  # Create a cycle scaffold
  ${APP_NAME} cycle plan "reduce checkout latency"

  # Show the latest cycle report
  ${APP_NAME} cycle report

  # Show cycle completeness and gate status
...
${chalk.bold("Environment Variables:")}
  ...
  ${ENV_SESSION_TRACE.padEnd(32)} - Enable full session trace logging when set to 1/true/yes
