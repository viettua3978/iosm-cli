...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "iosm-cli";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "iosm-cli";
