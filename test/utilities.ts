...
// ============================================================================
// OAuth API key resolution from ~/.iosm/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".iosm", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.iosm/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.iosm/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".iosm", "agent");

/**
 * Get an AuthStorage instance backed by ~/.iosm/agent/auth.json
