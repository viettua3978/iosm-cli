...
export interface ExtensionContext {
	...
	/** Gracefully shutdown iosm and exit. Available in all contexts. */
	shutdown(): void;
...
/** Fired when a task tool invocation starts a subagent run. */
...
/** Fired when a task tool invocation stops (success/error/cancel). */
...
/** Fired as a normalized completion event for task-tool executions. */
...
/** Fired when no subagent tasks are currently active. */
...
/** Fired when runtime/session configuration changes. */
...
export interface ExtensionAPI {
	...
	on(event: "subagent_start", handler: ExtensionHandler<SubagentStartEvent>): void;
	on(event: "subagent_stop", handler: ExtensionHandler<SubagentStopEvent>): void;
	on(event: "task_completed", handler: ExtensionHandler<TaskCompletedEvent>): void;
	on(event: "teammate_idle", handler: ExtensionHandler<TeammateIdleEvent>): void;
	on(event: "config_change", handler: ExtensionHandler<ConfigChangeEvent>): void;
