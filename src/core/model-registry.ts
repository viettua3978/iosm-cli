...
export class ModelRegistry {
	...
	constructor(
		...
		// Load models
		this.loadModels();
		this.ensureBuiltInProviders();
		this.applyRegisteredProviders();
	}
	...
	private ensureBuiltInProviders(): void {
		if (!this.registeredProviders.has(QWEN_CLI_PROVIDER_ID)) {
			this.registeredProviders.set(QWEN_CLI_PROVIDER_ID, createQwenCliProviderConfig());
		}
	}

	private applyRegisteredProviders(): void {
